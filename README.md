...
- `Networking/`: transport lifecycle interfaces, channel/message policy, point-to-point loopback, peer-addressed multi-client loopback, optional loss/reorder conditions, diagnostics, and the KCP/libdatachannel adapter seam.
